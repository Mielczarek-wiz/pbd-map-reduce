...
with DAG(
  ...
  mapreduce_classic = BashOperator(
    ...
    bash_command="""hadoop jar {{ params.dags_home }}/project_files/VictimsCounts.jar VictimsCounts {{ params.input_dir }}/datasource1 {{ params.output_mr_dir }}""",
  )
...
... """,
  ...
  hive = BashOperator(
    task_id="hive",
    bash_command="""hive -f {{ params.dags_home }}/project_files/transform.hql \
